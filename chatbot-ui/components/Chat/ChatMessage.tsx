    ...
    <div
      className={`group px-4 ${
        message.role === 'assistant'
          ? 'border-b dark:border-black/10 border-[#e0e0e0] dark:text-white text-[#333333] dark:bg-[#262546] bg-[#ffffff]'
          : 'border-b border-black/10  text-gray-800 dark:border-gray-900/50 dark:bg-[#302e58] bg-[#f7f7f8] dark:text-gray-100'
      }`}
          ...
          {message.role === 'user' ? (
            <div className="flex w-full">
              {isEditing ? (
                ...
                <div className="prose whitespace-pre-wrap dark:text-white text-[#333333]">
                  {message.content}
                </div>
              )}
            ...
            <>
              ...
              <MemoizedReactMarkdown
                className="prose dark:text-white text-[#333333]"
                ...
                components={{
                  code({ node, inline, className, children, ...props }) {
                    ...
                    return !inline ? (
                      ...
                      <code
                        className={`${className} dark:text-gray-400 text-[#333333]`}
                        {...props}
                      >
                        {children}
                      </code>
